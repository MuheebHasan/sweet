...
public class MainMenu {
	 private static String loggedInUserEmail; // لتخزين البريد الإلكتروني بعد تسجيل الدخول
	 private static String loggedInUsername;  // لتخزين اسم المستخدم بعد تسجيل الدخول
    ...
    private static MonitoringAndReportingww manager = new MonitoringAndReportingww();
